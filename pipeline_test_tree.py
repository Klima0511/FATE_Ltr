...
from pipeline.component import Reader, DataTransform, Evaluation, HomoSecureBoost  # Data I/O and Evaluation
...
guest_data = {"name": "web30k_homo_guest_1", "namespace": "experiment"}
host_data = {"name": "web30k_homo_host_1", "namespace": "experiment"}

pipeline = PipeLine().set_initiator(role='guest', party_id=guest).set_roles(guest=guest, host=host, arbiter=arbiter)

data_path_0 = '/data/Corpus/MSLR-WEB30K/Fold1/train.txt'
data_path_1 = '/data/Corpus/MSLR-WEB30K/Fold1/vali.txt'
...
model = t.nn.Sequential(
    t.nn.CustModel(module_name='GBM', class_name='MyCustomModel')
)
...
"""
nn_component = HomoSecureBoost(name='nn_0',
